...
function Hero({props} : Props) {
  return (
    <section className='md:my-6'>
        ...
        <div className="my-3 cursor-pointer w-full overflow-hidden rounded-2xl">
          <img src={urlFor(props.mainImage).url()!} alt="" className='object-fill w-full opacity-75 rounded-2xl max-h-[75vh]'/>
