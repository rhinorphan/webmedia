  ...
  return (
    <header className="flex justify-between max-w-7xl mx-auto font-franklin font-semibold p-5">
      ...
      <div className="flex gap-5 items-center">
        <a data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample" className="bg-poppy rounded-full px-4 py-1 cursor-pointer">S'abonner</a>
      </div>
