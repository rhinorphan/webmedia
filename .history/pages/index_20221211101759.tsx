...
export const getServerSideProps = async () => {
  ...
  const queryHero = `*[_type in ["actu", "societe", "culture"] && "À la une" in categories[]->title] | order(_createdAt desc)[0] {
    _id,
    title,
    author -> {
    name,
  ...
  const queryHero2 = `*[_type in ["actu", "societe", "culture"] && "À la une" in categories[]->title] | order(_createdAt desc)[1..4] {
    _id,
    title,
    author -> {
    name,
