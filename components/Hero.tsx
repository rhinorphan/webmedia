  ...
  return (
    <section className='md:my-6'>
        ...
        <div className="my-6 cursor-pointer w-full overflow-visible md:rounded-2xl">
          <img src={urlFor(props.mainImage).url()!} alt="" className='object-cover w-full md:rounded-2xl max-h-[75vh] border-y-poppy border-y-[3px] md:border-poppy md:border-[3px] hover:scale-105'/>
